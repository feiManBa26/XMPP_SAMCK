            ...
            case R.id.show_luntan_layout_back:
                if (result != null) {
                    if (MainActivity.main == null) {
                        XMPPTool.getInstance().connect(users.getUser(), users.getPassword(), new XMPPConnectionListener(){
                            @Override
...
//                    @Override
//                    public void run() {
//                        XMPPTool.getInstance().connect(users.getUser(), users.getPassword(), ShowLuntanActivity.this);
//                        if (result) {
//
//                            Intent intent = new Intent(ShowLuntanActivity.this, MainActivity.class);
//                            intent.putExtra("user", users);
